...
public class NewsItemView extends ItemView {
    ...
    public NewsItemView(View view) {
        ...
        eventText = (TextView) view.findViewById(R.id.tv_event);
        detailsText = (TextView) view.findViewById(R.id.tv_event_details);

        iconText = (TextView) view.findViewById(R.id.tv_event_icon);
        TypefaceUtils.setOcticons(iconText);

        dateText = (TextView) view.findViewById(R.id.tv_event_date);
    }
}
