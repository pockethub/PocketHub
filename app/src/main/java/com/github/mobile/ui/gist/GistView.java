...
public class GistView extends ItemView {
    ...
    public GistView(View view) {
        ...
        gistId = (TextView) view.findViewById(R.id.tv_gist_id);
        title = (TextView) view.findViewById(R.id.tv_gist_title);
        author = (TextView) view.findViewById(R.id.tv_gist_author);
        comments = (TextView) view.findViewById(R.id.tv_gist_comments);
        files = (TextView) view.findViewById(R.id.tv_gist_files);
