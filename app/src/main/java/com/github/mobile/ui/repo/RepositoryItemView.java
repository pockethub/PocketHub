...
public class RepositoryItemView extends ItemView {
    ...
    public RepositoryItemView(final View view) {
        ...
        repoIcon = (TextView) view.findViewById(R.id.tv_repo_icon);
        repoName = (TextView) view.findViewById(R.id.tv_repo_name);
        repoDescription = (TextView) view.findViewById(R.id.tv_repo_description);
        ...
        watchers = (TextView) view.findViewById(R.id.tv_watchers);
        forks = (TextView) view.findViewById(R.id.tv_forks);
    }
}