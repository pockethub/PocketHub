...
public class FilterItemView extends ItemView {
    ...
    public FilterItemView(final View view) {
        ...
        repoText = (TextView) view.findViewById(R.id.tv_repo_name);
        stateText = (TextView) view.findViewById(R.id.tv_filter_state);
        labelsText = (TextView) view.findViewById(R.id.tv_filter_labels);
        milestoneText = (TextView) view.findViewById(R.id.tv_filter_milestone);
        assigneeArea = view.findViewById(R.id.ll_assignee);
        assigneeText = (TextView) view.findViewById(R.id.tv_filter_assignee);
