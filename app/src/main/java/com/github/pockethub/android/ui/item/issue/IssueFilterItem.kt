...
import kotlinx.android.synthetic.main.issues_filter_item.view.*

class IssueFilterItem(private val avatarLoader: AvatarLoader, val issueFilter: IssueFilter) : Item<IssueFilterItem.ItemViewHolder>(issueFilter.hashCode().toLong()) {

    override fun bind(holder: ItemViewHolder, position: Int) {
        avatarLoader.bind(holder.root.iv_avatar, issueFilter.repository.owner())

        holder.root.tv_repo_name.text = InfoUtils.createRepoId(issueFilter.repository)
