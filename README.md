...
This repository contains the source code for the [GitHub Android app](https://play.google.com/store/apps/details?id=com.github.mobile" alt="logo" title="Download from Google Play)
